...
// The one brand mark in this set (issue #27) — every other icon here is a
// generic line glyph, but a GitHub connection control needs to actually
// read as GitHub. Path is Primer/Octicons' "mark-github" (16x16 viewBox,
// filled) rather than this file's usual 24x24 stroke convention — both are
// overridable per-icon since Svg spreads its props last.
export function GitHubIcon(props: IconProps) {
  return (
    <Svg viewBox="0 0 16 16" fill="currentColor" stroke="none" {...props}>
      <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.22.48-2.69-1.07-2.69-1.07-.36-.92-.88-1.17-.88-1.17-.72-.49.05-.48.05-.48.79.06 1.21.82 1.21.82.71 1.21 1.86.86 2.31.66.07-.52.28-.86.51-1.06-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82a7.6 7.6 0 0 1 4 0c1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z" />
    </Svg>
  );
}
...
// "Attach image" control (issue #68) — the classic picture-frame glyph, a
// generic line glyph matching this file's usual convention (no design-file
// source for this one — it's a new, small utility affordance, not a ported
// element).
